...
@section('content')
    <div class="container-fluid">
        <div class="panel shadow">
            ...
            <div class="header">
                <h2 class="title"><i class="fas fa-calendar-alt"></i><strong> Resultado(s) de Citas Buscadas de @if($tipo_cita == 1) RX @else Ultrasonido - Mamografia - Densitometria @endif</strong> </h2>
                <ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2" >                                
                                <div class="input-group">
                                    ...
                                    <a href="{{ url()->previous() }}" class="btn btn-warning">Limpiar</a>                                   
                                </div>                                
                            </div>
                        </div>
                                ...
                                <td>
                                    <div class="opts">
                                        @if(kvfj(Auth::user()->permissions, 'appointment_reschedule'))
                                            @if($a->status == '0')
                                                <a href="{{ url('/admin/cita/') }}" data-action="reprogramar" data-path="admin/cita" data-object="{{ $a->id }}" class="btn-deleted" data-toogle="tooltrip" data-placement="top" title="Reprogramación" ><i class="fas fa-calendar-alt"></i></a>
                                            @endif
                                            @if($a->status == '5')
                                                <a href="{{ url('/admin/cita/') }}" data-action="reprogramacion_forzada" data-path="admin/cita" data-object="{{ $a->id }}" class="btn-deleted" data-toogle="tooltrip" data-placement="top" title="Reprogramación Forzada" ><i class="fas fa-calendar-alt"></i></a>
                                            @endif
                                            @if($a->status == '0' || $a->status == '4' || $a->status == '5')
                                                <a href="{{ url('/admin/cita/') }}" data-date="{{$a->date}}" data-exam="{{$a->area}}" data-action="cambio_horario" data-path="admin/cita" data-object="{{ $a->id }}" class="btn-deleted" data-toogle="tooltrip" data-placement="top" title="Cambio de Horario" ><i class="fas fa-clock"></i></a>
                                            @endif
                                        @endif
                                        ...
                                        @if(kvfj(Auth::user()->permissions, 'appointment_patients_status'))
                                            @if($a->status == '0' || $a->status == '4')
                                                <a href="{{ url('/admin/cita/') }}" data-action="paciente_presente" data-path="admin/cita" data-object="{{ $a->id }}" class="btn-deleted" data-toogle="tooltrip" data-placement="top" title="Paciente Presente"><i class="fas fa-calendar-check"></i></a>
                                                <a href="{{ url('/admin/cita/') }}" data-action="paciente_ausente" data-path="admin/cita" data-object="{{ $a->id }}" class="btn-deleted" data-toogle="tooltrip" data-placement="top" title="Paciente Ausente"><i class="fas fa-calendar-times"></i></a>
                                            @endif
                                        @endif
