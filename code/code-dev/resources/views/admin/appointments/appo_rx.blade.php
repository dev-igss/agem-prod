...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/citas/rx') }}" class="nav-link"><i class="fas fa-calendar-alt"></i> Citas RX</a>
    </li>
@endsection
...
@section('content')
    <div class="container-fluid">
        <div class="panel shadow">
            ...
            <div class="header">
                <h2 class="title"><i class="fas fa-calendar-alt"></i><strong> Listado de Citas RX</strong> </h2>
                <ul>
            ...
            <div class="inside">  
                    ...
                    @csrf
                        <div class="row" >
                            ...
                            <div class="col-md-5" >                                
                                ...
                                <input type="hidden" class="form-control" name="type_appo" value="1" >   
                            </div>
                    ...
                    <span><strong><i class="fas fa-chevron-right"></i> Citas de RX: </strong> {{ $app_rx }}</span>
